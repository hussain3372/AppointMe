...
export default function Content() {
  ...
  return (
    <div className='h-screen p-5 flex flex-col justify-between sm:max-h-[calc(100vh-100px)] overflow-auto  bg-[#fef4ed]'>
      ...
      <div className={`flex ${showIntro ? "h-1/2" : ""}  flex-col pb-3 max-h-[calc(100vh-380px)] hide-scrollbar justify-end items-center`}>
            ...
            >
              <AnimatePresence>
                {messages.map((msg) => (
                  ...
                  >
                    <div className={`body-2 font-regular rounded-2xl px-4 py-3 max-w-[500px] ${msg.type === 'user' ? 'bg-[#FFFFFF] text-[#70747D]' : ' text-[#414652]'}`}>
                      {msg.file && (
                        <div className="mb-2">
                          {msg.file.isImage && msg.file.preview ? (
                            <img src={msg.file.preview} alt={msg.file.name} className="w-16 h-16 rounded-lg object-cover" />
                          ) : (
        ...
        <div className="bg-white rounded-3xl w-full p-4">
          <div className="relative">
            <textarea 
              ...
              style={{ paddingBottom: uploadedFile ? '72px' : '16px' }}
            />
            <AnimatePresence>
              {uploadedFile && (
                <motion.div 
