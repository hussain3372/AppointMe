...
export default function Stats() {
  ...
  return (
    <div>
      ...
      <div className="pt-5 grid gap-3  sm:grid-cols-2 md:grid-cols-5 ">
        {
            stats.map((stat)=>(
      ...
      <ConfirmationModal 
        ...
        message='Are you sure you want to delete this user? This action is permanent and cannot be undone. All associated campaigns, emails, and data will be permanently removed.'
