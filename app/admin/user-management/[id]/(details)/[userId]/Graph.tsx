      ...
      datasets: [
        {
          ...
          backgroundColor: (context: any) => {
            ...
            gradient.addColorStop(1, 'rgba(187, 247, 208, 0.1)');
            return gradient;
          },
  ...
  return (
    <div className="w-full bg-[white] border border-[#ECEDEE] px-5 pt-5 pb-[15px] rounded-lg">
      <div className="flex flex-col sm:flex-row justify-between items-center mb-5">
        <h1 className="font-medium text-[#111827] heading-4">Campaign performance</h1>
      ...
      <div className="flex gap-5 mb-5 heading-7 font-normal">
        <span className="text-[#11224E] border-l border-[#11224E] pl-2 rounded-[2px] leading-4 transition-all duration-300 hover:pl-3">
          Emails send
        </span>
        <span className="text-[#11224E] border-l border-[#F87B1B] pl-2 rounded-[2px] leading-4 transition-all duration-300 hover:pl-3">
          Opened
        </span>
        <span className="text-[#11224E] border-l border-[#0CD767] pl-2 rounded-[2px] leading-4 transition-all duration-300 hover:pl-3">
          Replies
        </span>
      </div>

      <div className={`w-full h-38 transition-opacity duration-500 ${isAnimating ? 'opacity-80' : 'opacity-100'}`}>
