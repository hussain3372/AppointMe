...
const Header: React.FC<HeaderProps> = ({ onMenuClick }) => {
  ...
  // Extract segments and determine base module
  ...
  // Base module is the FIRST segment after filtering 'admin'
  const baseModule = filteredSegments[0] || "dashboard";
  ...
  const ActiveRouteIcon = routeIcons[baseModule] || routeIcons.dashboard;
                              ...
                              <div className="flex items-start gap-3">
                                ...
                                <div className="space-y-1 max-w-[258px]">
                                  ...
                                  <p className="text-[#00000066] body-4">
                                    Your {notification.title.toLowerCase()} was
