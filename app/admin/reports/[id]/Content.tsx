...
export default function Content(): React.ReactElement {
  ...
  return (
    <div className="pt-5 sm:px-5 overflow-auto hide-scrollbar">
      <div className="flex flex-col sm:flex-row items-start justify-start gap-4 max-w-full overflow-x-auto">
        <div className="bg-[#F2F2F2] w-[350px] sm:max-w-[450px] inline-flex gap-1 p-1 rounded-lg flex-1 relative">
