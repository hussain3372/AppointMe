  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row justify-between items-center mb-4">
        <h2 className="body-1 font-medium text-[#111827]">Revenue over time</h2>
      ...
      <div className="relative flex-1">
        ...
        {/* Dot Heatmap */}
        <div className="ml-10 max-w-[90%] sm:max-w-none w-full h-full flex flex-col">
          <div
          ...
          <div className="flex mt-2 text-sm text-[#414652] font-normal overflow-visible">
            {months.map((month) => (
              ...
              >
               <p className="-rotate-45 sm:rotate-0"> {month} </p>
              </div>
            ))}
          </div>
        </div>
