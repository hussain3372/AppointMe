  ...
  return (
    <div>
      <div className="flex gap-2 items-center">
        <Link
          className="heading-6 font-regular text-[#70747D] hover:text-blue-500 hover:underline"
          href="/admin/campaign-management"
        >
          Campaign management
        </Link>
        <Image
          src="/images/gap-img.svg"
          alt="campaigns"
          height={20}
          width={20}
        />
      ...
      <div className="pt-5 flex flex-col sm:flex-row justify-between">
        <div className="space-y-2">
          ...
          <h5 className="heading-5 font-regular text-[#70747D]">
            Promoting our latest product to potential leads.
          </h5>
        </div>
      ...
      <div className="pt-5 grid gap-3  sm:grid-cols-2 md:grid-cols-4 ">
        {stats.map((stat) => (
          <div key={stat.id} className="bg-[#F4F4F4] p-3 rounded-lg">
            <div className=" flex w-full gap-3 items-center">
              ...
              <div className="space-y-1">
                <h4 className="heading-4 font-regular text-[#111827]">
                  {stat.value}
                </h4>
      ...
      <ConfirmationModal
        ...
        message="Are you sure you want to delete the campaign Product Launch? This action cannot be undone. All associated emails, stats, and settings will be permanently removed."
      ...
      <div className="flex flex-col lg:flex-row gap-3 w-full pt-5">
        ...
        <div className="p-3 w-full border border-[#ECEDEE]  bg-white rounded-lg">
          <h1 className="heading-4 font-medium mb-5 text-[#111827]">Campaign details</h1>
