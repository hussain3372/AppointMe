      ...
      <AnimatePresence>
        {isDrawerOpen && (
          <>
            ...
            {/* Drawer */}
            <motion.div
              className="fixed top-0 right-0 h-full w-full sm:w-[580px] bg-white z-50 rounded-l-lg p-5"
              initial={{ x: "100%" }}
              animate={{ x: 0 }}
              exit={{ x: "100%" }}
                ...
                <div>
                  <div className="flex justify-between items-center mb-1">
                    <h2 className="heading-4 font-medium text-[#111827]">
                      Select email for leads
                    </h2>
                  </div>

                  <div>
                    <p className="text-[#70747D] body-4 font-normal">
                      Compose and send personalized emails to your selected
                      leads instantly.
                    </p>
                  </div>
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="flex items-start gap-3 p-3 bg-[#ECFDF2] border border-transparent hover:border-[#0CD767] rounded-lg shadow-[0_4px_8px_0_rgba(0,112,127,0.04)]">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="body-4 text-[#70747D]">
                          Greet new subscribers with a personalized welcome
                          message. Introduce your brand, set expectations, and
                          encourage them to explore your platform or latest
                          offerings.
                        </p>
                      </div>
                      <Image
                    ...
                    <div className="flex items-start gap-3 p-3 bg-[#ECFBFD] border border-transparent hover:border-[#5de6f8] rounded-lg shadow-[0_4px_8px_0_rgba(0,112,127,0.04)]">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="body-4 text-[#70747D]">
                          Automatically remind customers about pending or
                          upcoming payments. Maintain professionalism while
                          ensuring timely billing and smooth cash flow.
                        </p>
                      </div>
                      <Image
                        src="/images/file-search.svg"
                    ...
                    <div className="flex items-start gap-3 p-3 bg-[#FDECFB] border border-transparent hover:border-[#fc5fe9] rounded-lg shadow-[0_4px_8px_0_rgba(0,112,127,0.04)]">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="body-4 text-[#70747D]">
                          ...
                          updates, or recommendations. Show them what’s new and
                          remind them why they loved your brand in the first
                          place.
                        </p>
                      </div>
                      <Image
