...
export default function Editor() {
  ...
  return (
    <div className=" mx-auto h-full bg-[#F6F6F6] p-3 rounded-lg">
      <style>{`
        .ql-container {
      ...
      <div className="flex items-start gap-3 mb-6">
        <div className="p-3 bg-[#FFFFFF] shadow-md rounded-lg  flex items-center justify-center flex-shrink-0">
          <Image src='/images/template.svg' alt='Template' height={24} width={24} />
        </div>
        <div className="flex flex-col gap-1">
          <p className="heading-4 font-semibold text-[#111827]">Your journey with us starts here</p>
      ...
      <div className="pt-[118px] w-full flex items-end justify-between">
      <button onClick={OpenModal} className="heading-6 cursor-pointer font-regular text-[#70747D] underline h-5">Delete template</button>
      <div className=''>
      <PrimaryBtn onClick={openDrawer} label='Send email' imageSrc='/images/arrow-right.svg' imagePosition='right'                 fontSize="12px"
 />
      </div>
      </div>
      {
        isOpenModal && (
          <ConfirmationModal isOpen={isOpenModal} onClose={OpenModal} onConfirm={()=>{setIsOpenModal}} title='Do you want to delete this template' message='This email will be permanently removed from your templates. You won’t be able to recover it once deleted.' icon='/images/delete.png'/>
        )
      }
        <AnimatePresence>
               {isDrawerOpen && (
