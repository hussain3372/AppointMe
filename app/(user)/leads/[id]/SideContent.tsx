  ...
  return (
    <div className="pt-5 h-full flex flex-col">
      ...
      <div className="flex gap-2 items-center text-[#70747D] flex-shrink-0 px-4">
        <Link
          href="/leads"
          className="heading-6 font-regular leading-[20px] hover:text-blue-500 hover:underline"
        >
          Leads
        </Link>
        <Image
          src="/images/center-arrow.svg"
          alt="Arrow"
          height={20}
          width={20}
        />
      ...
      <div className="flex-1 overflow-y-auto hide-scrollbar">
        <div className="flex flex-col min-h-full">
          <div className="flex flex-col items-center pt-[32px] flex-1">
            ...
            <div className="shrink-0 text-center">
              ...
              <div className="flex items-center justify-center  mt-2">
                ...
                <p className="heading-7 font-normal text-[#70747D] -translate-y-1">
                  Google
                </p>
              </div>
            </div>
            ...
            <div className="flex gap-5 shrink-0 px-4 mt-5">
              ...
              <div className="flex flex-col  items-center gap-2  relative">
                <ActionDropdown row={selectedContact} actions={getActions} />
            ...
            <div className="flex gap-1 pt-5 items-center shrink-0">
              ...
              <p className="heading-7 font-normal text-[#111827]">
                Aug 12, 2025
              </p>
            </div>

            {/* Leads info */}
            <div className="pt-8 w-full shrink-0 pr-4">
              <div className="flex justify-between">
                <p
                  className={`heading-7 font-normal ${!isOpen ? "0" : "pl-5"}`}
                >
                  LEADS INFO
                </p>
            ...
            >
              <div className="flex flex-col gap-2 w-full items-center">
                {data.map((item) => (
                  <div
                    key={item.id}
                    className="bg-[#FEF4ED] w-full p-3 rounded-lg flex justify-between"
                  >
                    <div>
                      <p className="heading-7 font-normal text-[#70747D]">
                        {" "}
                      ...
                      <p className="heading-7 font-medium text-[#111827] mt-1 cursor-pointer">
                        {" "}
                        {item.value}
                      </p>
                    </div>
          ...
          <div className="w-full px-4 py-5 shrink-0 mt-auto">
            <PrimaryBtn
              fontSize="12px"
