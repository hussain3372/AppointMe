          ...
          {dateMeetings.map((meeting) => (
            <div key={meeting.id} className="bg-[#F6F6F6] rounded-lg border border-[#ECEDEE] p-3">
                ...
                <div className="flex sm:gap-5 items-center">
                  <div className="flex gap-1 sm:gap-2 items-center">
                    <Image 
                      ...
                      width={16} 
                    />
                    <p className="heading-7 text-[#70747D] font-normal">{meeting.time}</p>
                  </div>
              ...
              <div className="mt-2 p-3 bg-white shadow-[0_4px_8px_0_rgba(0,0,0,0.08)] rounded-lg flex flex-col gap-2">
                ...
                <p className="heading-7 font-normal text-[#70747D]">{meeting.content}</p>

                <div className="flex gap-2 flex-col sm:flex-row w-full">
                  <div className=" w-full flex gap-2 p-3 border border-[#E2E3E5] rounded-lg">
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[#70747D] font-normal heading-7">Meeting time</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="pt-5 w-full flex gap-2 p-3 border border-[#E2E3E5] rounded-lg">
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col gap-1">
                        ...
                        <p className="text-[#70747D] font-normal heading-7">Duration</p>
                      </div>
                    </div>
                  </div>
                    ...
                    <div className="flex gap-3 items-center">
                      ...
                      <div className="flex flex-col gap-1">
                        <div className="flex">
                          ...
                          <p className="text-[#F87B1B] heading-7 font-normal">+ 2 more</p>  
                        </div>
                        <p className="text-[#70747D] font-normal heading-7">Attendees</p>
                      </div>
                    </div>
                  </div>
                </div>
