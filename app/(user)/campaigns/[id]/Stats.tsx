  ...
  return (
    <div>
      <div className="flex gap-2 items-center">
        <Link className='heading-6 font-regular text-[#70747D] hover:text-blue-500 hover:underline' href='/campaigns'>CAMPAIGNS</Link>
        <Image src='/images/gap-img.svg' alt='campaigns' height={20} width={20}/>
        <p className="heading-6 font-regular text-[#70747D]">NEW PRODUCT LAUNCH</p>
      </div>
      <div className="pt-5 flex flex-col sm:flex-row justify-between">
        <div className="space-y-2">
            <h4 className="heading-4 font-medium text-[#111827]">New product launch</h4>
            <h5 className="heading-5 font-regular text-[#70747D]">Promoting our latest product to potential leads.</h5>
        </div>
      ...
      <div className='flex flex-col lg:flex-row gap-3 w-full pt-5'>
        ...
        <div className="p-3 w-full border border-[#ECEDEE]  bg-white rounded-lg">
          <h1 className="heading-4 font-medium mb-5">Campaign details</h1>
