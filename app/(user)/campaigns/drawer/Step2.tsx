...
const Step2 = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      ...
      if (
        followUpIntervalRef.current &&
        !followUpIntervalRef.current.contains(event.target as Node)
      ) {
        setFollowUpIntervalOpen(false);
      }
      if (
        frequencyRef.current &&
        !frequencyRef.current.contains(event.target as Node)
      ) {
          ...
          >
            ...
            <div className="flex justify-between w-full items-center">
              <div className="space-y-1">
                <h2 className="heading-5 font-medium text-[#111827]">
                  Select template
                </h2>
                <p className="body-5 font-normal text-[#70747D]">
          ...
          <div className="relative">
            <div className="cursor-pointer relative z-10">
              <Input
                ...
                className="w-full cursor-pointer placeholder:text-[#414652] bg-white"
