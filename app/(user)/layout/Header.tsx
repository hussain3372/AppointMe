...
const Header: React.FC<HeaderProps> = ({ onMenuClick, isMobile }) => {
  ...
  // Base module is always the FIRST segment after "/"
        ...
        <div className="flex items-center gap-3">
          <div className="rounded-full hidden sm:flex  items-center gap-2 p-3 bg-[#FEF4ED] border border-[#FEE5D1]">
            ...
            <div className="flex gap-1 ">
              <p className="heading-6 font-regular text-[#111827]">
                Your outreach trial expires in 7 days.
              </p>
              <Link href="#" className="heading-6 font-medium text-[#111827]">
                Upgrade now
              </Link>
            </div>
          </div>
