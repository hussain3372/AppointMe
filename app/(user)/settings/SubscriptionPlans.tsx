...
import PricingCard from "@/app/shared/PlanCard"; // adjust path
      ...
      <div className="container mx-auto p-3 rounded-lg bg-[#F6F6F6] ">
        ...
        ${
          billingPeriod === "Monthly"
            ? "bg-[#F2F2F2] border border-[#E2E3E5] text-[#111827] heading-6 font-normal shadow-sm"
            : "text-[#111827] hover:text-[#111827] hover:bg-gray-50"
        }
