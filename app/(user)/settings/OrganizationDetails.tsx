...
const OrganizationDetails: React.FC = () => {
  ...
  // Actual values (saved)
  const [companyName, setCompanyName] = useState<string>("Enter name");
  const [organizationId, setOrganizationId] = useState<string>("Enter ID");
  const [industry, setIndustry] = useState<string>("Choose industry");
  const [websiteUrl, setWebsiteUrl] = useState<string>("Enter URL");
  const [email, setEmail] = useState<string>("Enter email");
  const [phoneNumber, setPhoneNumber] = useState<string>("Enter number");
