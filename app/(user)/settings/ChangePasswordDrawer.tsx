...
export default function Drawer({ onClose }: { onClose: () => void }) {
    ...
    return (
        <div className="flex flex-col h-full">
                        ...
                        >
                            ...
                            <div className="space-y-2 flex flex-col items-end">
                                <Input 
                                    ...
                                    type="password"
                                />
                                <Link href='/forgot-password' className="heading-7 font-medium text-[#F87B1B] text-end">
                                    Forget password
                                </Link>
                            </div>
                        </motion.div>
                    ...
                    {stepCount === 2 && (
                        ...
                        >
                            <div className="space-y-1">
                                ...
                                <p className="heading-6 font-regular text-[#70747D]">
                                    Enter your new secure password. Make sure it's strong and unique.
                                </p>
                            </div>
            ...
            {
                openModal && (
                    <ConfirmationModal isOpen={openModal} onClose={handleOpenModal} onConfirm={onClose} cancelText="Cancel" confirmText="OK" title="Password changed" message="Password changed successfully" />
                )
            }
        </div>
    );
