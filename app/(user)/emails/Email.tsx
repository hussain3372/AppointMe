    ...
    <div className="relative space-y-5">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between">
        <div className="space-y-2">
          <h1 className="heading-4 font-medium text-[#111827]">Sent emails & responses</h1>
          <p className="heading-5 font-regular text-[#70747D]">
            Track your email performance and engage Email effectively.
          </p>
        </div>
      ...
      {/* Table Section */}
      <div>
        <EmailTable setIsDrawerOpen={setIsDrawerOpen} />
      </div>
                     ...
                     >
                       ...
                       <div>
                         <p className="text-[#70747D] body-4 font-normal">
                           Compose and send personalized emails to your selected Email
                           instantly.
                         </p>
                       </div>
                       ...
                       <div className="space-y-5">
                         ...
                         <div className="flex items-start gap-3 p-3 bg-[#ECFDF2] border border-transparent hover:border-[#0CD767] rounded-lg shadow-[0_4px_8px_0_rgba(0,112,127,0.04)]">
                           ...
                           <div className="space-y-1">
                             <h2 className="heading-5 text-[#111827] font-medium">Welcome Email</h2>
                         ...
                         <div className="flex items-start gap-3 p-3 bg-[#FDF5EC] border border-transparent hover:border-[#f5ad5a] rounded-lg shadow-[0_4px_8px_0_rgba(0,112,127,0.04)]">
                           ...
                           />
                           <div className="space-y-1">
                             <h2 className="heading-5 text-[#111827] font-medium">
                               Monthly Newsletter
                             </h2>
                             <p className="body-4 text-[#70747D]">
                         ...
                         <div className="flex gap-3">
                           ...
                           <PrimaryBtn label="Send email" imageSrc="/images/arrow-right.svg" imagePosition="right"                 fontSize="12px"
/>
                         </div>
                       </div>
                     </motion.div>
